...
#define protocol_VERSION    "00000006"              ///< protocol version
#define P0_VERSION          "00000002"              ///< P0 protocol version

/**@name Product Key  
* @{
*/
#define PRODUCT_KEY "318b94b91f044bbea84d4b06f92dad3b"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "4d94f870d65d4b2b9bb29f605c4c08e3"
...
* @{
*/
#define SW1_OnOff_BYTEOFFSET                    0
#define SW1_OnOff_BITOFFSET                     0
#define SW1_OnOff_LEN                           1
#define Time_OnOff_BYTEOFFSET                    0
#define Time_OnOff_BITOFFSET                     1
#define Time_OnOff_LEN                           1
#define SW2_OnOff_BYTEOFFSET                    0
#define SW2_OnOff_BITOFFSET                     2
#define SW2_OnOff_LEN                           1
#define LIGHT_BUTTON_BYTEOFFSET                    3
#define LIGHT_BUTTON_BITOFFSET                     0
#define LIGHT_BUTTON_LEN                           1
#define WORRY_MQ_BYTEOFFSET                    10
#define WORRY_MQ_BITOFFSET                     0
#define WORRY_MQ_LEN                           1
...
#define DHT11_wendu_RATIO                         1
#define DHT11_wendu_ADDITION                      0
#define DHT11_wendu_MIN                           0
#define DHT11_wendu_MAX                           40
#define DHT11_shidu_RATIO                         1
#define DHT11_shidu_ADDITION                      0
#define DHT11_shidu_MIN                           20
#define DHT11_shidu_MAX                           95
#define Power1_Consumption_RATIO                         0.1
#define Power1_Consumption_ADDITION                      0
#define Power1_Consumption_MIN                           0
#define Power1_Consumption_MAX                           22000
#define Power2_Consumption_RATIO                         0.1
#define Power2_Consumption_ADDITION                      0
#define Power2_Consumption_MIN                           0
#define Power2_Consumption_MAX                           22000
/**@} */
...
typedef struct {
  ...
  bool valueLIGHT_BUTTON;
  uint32_t valueDHT11_wendu;
  uint32_t valueDHT11_shidu;
  float valuePower1_Consumption;
  float valuePower2_Consumption;
  bool valueWORRY_MQ;
} dataPoint_t;
...
typedef struct {
  uint8_t flagSW1_OnOff:1;
  uint8_t flagTime_OnOff:1;
  uint8_t flagSW2_OnOff:1;
...
typedef struct {
  ...
  uint8_t valueDHT11_wendu;
  uint8_t valueDHT11_shidu;
  uint16_t valuePower1_Consumption;
  uint16_t valuePower2_Consumption;
